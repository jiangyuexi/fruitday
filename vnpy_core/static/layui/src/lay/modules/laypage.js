...
layui.define(function(exports){
  ...
  Class.prototype.view = function(){
    ...
    ,views = {
      ...
      prev: function(){
        return config.prev 
          ? '<a href="javascripts:;" class="layui-laypage-prev'+ (config.curr == 1 ? (' ' + DISABLED) : '') +'" data-page="'+ (config.curr - 1) +'">'+ config.prev +'</a>'
        : '';
      }()
      ...
      ,page: function(){
        ...
        if(index > 1 && config.first !== false && groups !== 0){
          pager.push('<a href="javascripts:;" class="layui-laypage-first" data-page="1"  title="&#x9996;&#x9875;">'+ (config.first || 1) +'</a>');
        }
        ...
        for(; start <= end; start++){
          if(start === config.curr){
            ...
            pager.push('<a href="javascripts:;" data-page="'+ start +'">'+ start +'</a>');
          }
        }
        ...
        if(config.pages > groups && config.pages > end && config.last !== false){
          ...
          if(groups !== 0){
            pager.push('<a href="javascripts:;" class="layui-laypage-last" title="&#x5C3E;&#x9875;"  data-page="'+ config.pages +'">'+ (config.last || config.pages) +'</a>');
          }
        }
      ...
      ,next: function(){
        return config.next 
          ? '<a href="javascripts:;" class="layui-laypage-next'+ (config.curr == config.pages ? (' ' + DISABLED) : '') +'" data-page="'+ (config.curr + 1) +'">'+ config.next +'</a>'
        : '';
      }()
