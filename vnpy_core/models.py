...
class Openinterest(models.Model):
    timestamp = models.TextField(primary_key=True)  # This field type is a guess.
    symbol = models.TextField(blank=True, null=True)  # This field type is a guess.
    openinterest = models.FloatField(db_column='openInterest', blank=True, null=True)  # Field name made lowercase.
    markprice = models.FloatField(db_column='markPrice', blank=True, null=True)  # Field name made lowercase.

    class Meta:
        managed = False
        db_table = 'openInterest'
